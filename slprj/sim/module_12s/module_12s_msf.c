...
#define S_FUNCTION_NAME module_12s_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; cmytdbuhw4 ( & ( dw -> rtdw ) , localX ) ; } static void mdlReset ( SimStruct * S ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; hpcskk5akc ( & ( dw -> rtdw ) , localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; real_T const * i_pwgeped2j1 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_i_i_b53slvtkal = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_m5xg53ijlw = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_i_i_dh2drwn4y4 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_i_i_cfpf3on5yv = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_i_i_odov20bepj = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_li25tqv00k = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const * i_mpcngan0pc = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T const * i_ebgmoerc5o = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ; real_T const * i_cpiko1wkud = ( real_T * ) ssGetInputPortSignal ( S , 9 ) ; real_T const * i_i_i_dm4nzhttrc = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_3_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_3_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_3_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; if ( tid == 0 ) { module_12s ( i_pwgeped2j1 , i_i_i_b53slvtkal , i_m5xg53ijlw , i_i_i_dh2drwn4y4 , i_i_i_cfpf3on5yv , i_i_i_odov20bepj , i_li25tqv00k , i_mpcngan0pc , i_ebgmoerc5o , i_cpiko1wkud , i_i_i_dm4nzhttrc , o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , & ( dw -> rtdw ) , localX ) ; kekbfk5ydx ( i_i_i_b53slvtkal , i_i_i_dh2drwn4y4 , i_i_i_cfpf3on5yv , i_i_i_odov20bepj , i_i_i_dm4nzhttrc , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 48 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetNumPeriodicContStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 11 , 5 ) ; if ( ! ssSetNumInputPorts ( S , 11 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
( S , 0 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 1 , 12 ) )
...
( S , 2 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 3 , 12 ) )
...
( S , 3 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 4 , 12 ) )
...
( S , 4 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 5 , 12 ) )
...
( S , 9 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 10 , 12 ) )
...
ssSetOutputPortVectorDimension ( S , 1 , 12 ) ) return ;
...
ssSetOutputPortVectorDimension ( S , 2 , 12 ) ) return ;
...
ssSetOutputPortVectorDimension ( S , 3 , 12 ) ) return ;
...
ssSetOutputPortVectorDimension ( S , 4 , 12 ) ) return ;
...
mr_module_12s_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_module_12s_MdlInfoRegFcn
( S , "module_12s" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( eukyfajbmmh ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } garwwd4yu1 ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) , & ( dw -> rtdw ) , localX , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; real_T const * i_pwgeped2j1 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_i_i_b53slvtkal = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_m5xg53ijlw = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_i_i_dh2drwn4y4 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_i_i_cfpf3on5yv = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_i_i_odov20bepj = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_li25tqv00k = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const * i_mpcngan0pc = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T const * i_ebgmoerc5o = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ; real_T const * i_cpiko1wkud = ( real_T * ) ssGetInputPortSignal ( S , 9 ) ; real_T const * i_i_i_dm4nzhttrc = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_3_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_3_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_3_5 = ( real_T * ) ssGetOutputPortSignal ( S , 4 ) ; mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { module_12s ( i_pwgeped2j1 , i_i_i_b53slvtkal , i_m5xg53ijlw , i_i_i_dh2drwn4y4 , i_i_i_cfpf3on5yv , i_i_i_odov20bepj , i_li25tqv00k , i_mpcngan0pc , i_ebgmoerc5o , i_cpiko1wkud , i_i_i_dm4nzhttrc , o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , & ( dw -> rtdw ) , localX ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { eukyfajbmmh * dw = ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_b53slvtkal = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_i_i_dh2drwn4y4 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_i_i_cfpf3on5yv = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_i_i_odov20bepj = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_i_i_dm4nzhttrc = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ; kekbfk5ydx ( i_i_i_b53slvtkal , i_i_i_dh2drwn4y4 , i_i_i_cfpf3on5yv , i_i_i_odov20bepj , i_i_i_dm4nzhttrc , & ( dw -> rtdw ) ) ; return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { eukyfajbmmh * dw = ( eukyfajbmmh
* ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_b53slvtkal = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; real_T const * i_i_i_dh2drwn4y4 = ( real_T *
) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_i_i_cfpf3on5yv = ( real_T
* ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_i_i_odov20bepj = ( real_T
* ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_i_i_dm4nzhttrc = ( real_T
* ) ssGetInputPortSignal ( S , 10 ) ; mzmnekx0vt * localXdot = ( mzmnekx0vt *
) ssGetdX ( S ) ; coyppjg3er ( i_i_i_b53slvtkal , i_i_i_dh2drwn4y4 ,
i_i_i_cfpf3on5yv , i_i_i_odov20bepj , i_i_i_dm4nzhttrc , & ( dw -> rtdw ) ,
localXdot ) ; } static void mdlTerminate ( SimStruct * S ) { eukyfajbmmh * dw
= ( eukyfajbmmh * ) ssGetDWork ( S , 0 ) ; btwsdrwuu2 ( & ( dw -> rtdw ) , &
( dw -> rtm ) ) ; return ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const mgyoq5wkxu
* localX = ( const mgyoq5wkxu * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( mgyoq5wkxu ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_module_12s_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0
, 1 , mdlrefDW ) ; } { mxArray * data =
mr_module_12s_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
mgyoq5wkxu * localX = ( mgyoq5wkxu * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( mgyoq5wkxu ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_module_12s_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
