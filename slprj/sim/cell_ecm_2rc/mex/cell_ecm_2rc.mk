...
## Generated on : Wed Apr 01 03:59:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/cell_ecm_2rc_msf.mexw64
...
MODELREF_LINK_RSPFILE     = cell_ecm_2rc_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/cell_ecm_2rc_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/cell_ecm_2rc/cell_ecm_2rc_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = cell_ecm_2rc_msf.obj c_mexapi_version.obj
...
cell_ecm_2rc_msf.obj : $(START_DIR)/slprj/sim/cell_ecm_2rc/cell_ecm_2rc_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
